    ...
    <div class="pt-12 px-4 sm:px-6 lg:px-8 lg:pt-20">
      <div class="text-center">
        ...
        <p class="mt-3 max-w-4xl mx-auto text-xl leading-7 text-gray-300 sm:mt-5 sm:text-2xl sm:leading-8">
          Toast comes in a community distribution called Bread, and a paid
                  ...
                  <div class="flex-1 flex flex-col justify-between border-t-2 border-gray-100 p-6 bg-gray-50 sm:p-10 lg:p-6 xl:p-10">
                    ...
                    <div class="mt-8">
                      <div class="rounded-lg">
                        <span
                          href="#"
                          class="block w-full text-center rounded-lg border border-transparent  px-6 py-3 text-base leading-6 font-medium text-gray-600 hover:text-gray-500 focus:outline-none focus:shadow-outline transition ease-in-out duration-150"
                ...
                <div class="border-t-2 border-gray-100 rounded-b-lg pt-10 pb-8 px-6 bg-gray-50 sm:px-10 sm:py-10">
                  <ul>
                    <li class="flex items-start">
                      ...
                      <p class="ml-3 text-base leading-6 font-medium text-gray-500">
                        Use on personal sites or client sites you individually
                        contract with
                      </p>
                    </li>
                    <li class="mt-4 flex items-start">
                  ...
                  <div class="mt-10">
                    <div class="rounded-lg shadow-md">
                      <a
                        href="#"
                        class="block w-full text-center rounded-lg border border-transparent bg-teal-600 px-6 py-4 text-xl leading-6 font-medium text-white hover:bg-teal-500 focus:outline-none focus:border-teal-700 focus:shadow-outline-teal transition ease-in-out duration-150"
                  ...
                  <div class="bg-white px-6 py-10">
                    <div>
                      ...
                      <div class="mt-4 flex items-center justify-center">
                        <span class="px-3 flex items-start text-6xl leading-none tracking-tight text-gray-900">
                          <span class="mt-2 mr-2 text-4xl font-medium">$</span>
                          <span class="font-extrabold">989</span>
                        </span>
                        <span class="text-xl leading-7 font-medium text-gray-500">
                          /year
                        </span>
                  ...
                  <div class="flex-1 flex flex-col justify-between border-t-2 border-gray-100 p-6 bg-gray-50 sm:p-10 lg:p-6 xl:p-10">
                    ...
                    <div class="mt-8">
                      <div class="rounded-lg shadow-md">
                        <a
                          href="#"
                          class="block w-full text-center rounded-lg border border-transparent bg-white px-6 py-3 text-base leading-6 font-medium text-teal-600 hover:text-teal-500 focus:outline-none focus:shadow-outline transition ease-in-out duration-150"
